...
WORKDIR /app
COPY . .
RUN sed -i 's/export const backendHost = process.env.NEXT_PUBLIC_BACKEND_HOST;/export const backendHost = "https:\/\/xds-admin.deloitteopenlxp.com";/' ./src/config/endpoints.js
